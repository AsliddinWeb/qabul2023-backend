...
from .serializers import (FilialSerializer, TalimTuriSerializer,
                          TalimShakliSerializer, YonalishSerializer, RegisterSlayderSerializer)
...
class RegisterSlayderListView(generics.ListAPIView):
    queryset = RegisterSlayder.objects.all()
    serializer_class = RegisterSlayderSerializer
